...
def sgd_momentum(w, dw, config=None):
    ...
    # Retrieve the momentum and the learning rate from the config dictionary. 
...
def rmsprop(w, dw, config=None):
    ...
    # RMSprop keeps a "leaky" running average of squared gradients. 
    # The leakiness is to solve the aggressiveness of Adagrad. 
